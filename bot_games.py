...
_PRESET_DATA: dict[str, dict] = {
    "colors": {
        ...
        "answers_hints": {
            ...
            "Cyan":     ["Used in CMYK printing", "Made by mixing blue and green"],
    ...
    "countries_africa" = {
        ...
        "answers_hints": {
            # Northern Africa
            "Algeria":                      _ch("Northern Africa","Africa","A","Algeria"),
            "Egypt":                        _ch("Northern Africa","Africa","C","Egypt"),
            "Libya":                        _ch("Northern Africa","Africa","T","Libya"),
            "Morocco":                      _ch("Northern Africa","Africa","R","Morocco"),
            "Sudan":                        _ch("Northern Africa","Africa","K","Sudan"),
            "Tunisia":                      _ch("Northern Africa","Africa","T","Tunisia"),
            # Western Africa
            "Benin":                        _ch("Western Africa","Africa","P","Benin"),
            "Burkina Faso":                 _ch("Western Africa","Africa","O","Burkina Faso"),
            "Cape Verde":                   _ch("Western Africa","Africa","P","Cape Verde"),
            "Ivory Coast":                  _ch("Western Africa","Africa","Y","Ivory Coast"),
            "Gambia":                       _ch("Western Africa","Africa","B","Gambia"),
            "Ghana":                        _ch("Western Africa","Africa","A","Ghana"),
            "Guinea":                       _ch("Western Africa","Africa","C","Guinea"),
            "Guinea-Bissau":                _ch("Western Africa","Africa","B","Guinea-Bissau"),
            "Liberia":                      _ch("Western Africa","Africa","M","Liberia"),
            "Mali":                         _ch("Western Africa","Africa","B","Mali"),
            "Mauritania":                   _ch("Western Africa","Africa","N","Mauritania"),
            "Niger":                        _ch("Western Africa","Africa","N","Niger"),
            "Nigeria":                      _ch("Western Africa","Africa","A","Nigeria"),
            "Senegal":                      _ch("Western Africa","Africa","D","Senegal"),
            "Sierra Leone":                 _ch("Western Africa","Africa","F","Sierra Leone"),
            "Togo":                         _ch("Western Africa","Africa","L","Togo"),
            # Central Africa
            "Angola":                       _ch("Central Africa","Africa","L","Angola"),
            "Cameroon":                     _ch("Central Africa","Africa","Y","Cameroon"),
            "Central African Republic":     _ch("Central Africa","Africa","B","Central African Republic"),
            "Chad":                         _ch("Central Africa","Africa","N","Chad"),
            "Democratic Republic of the Congo": _ch("Central Africa","Africa","K","Democratic Republic of the Congo"),
            "Equatorial Guinea":            _ch("Central Africa","Africa","M","Equatorial Guinea"),
            "Gabon":                        _ch("Central Africa","Africa","L","Gabon"),
            "Republic of the Congo":        _ch("Central Africa","Africa","B","Republic of the Congo"),
            "Sao Tome and Principe":        _ch("Central Africa","Africa","S","Sao Tome and Principe"),
            # Eastern Africa
            "Burundi":                      _ch("Eastern Africa","Africa","G","Burundi"),
            "Comoros":                      _ch("Eastern Africa","Africa","M","Comoros"),
            "Djibouti":                     _ch("Eastern Africa","Africa","D","Djibouti"),
            "Eritrea":                      _ch("Eastern Africa","Africa","A","Eritrea"),
            "Ethiopia":                     _ch("Eastern Africa","Africa","A","Ethiopia"),
            "Kenya":                        _ch("Eastern Africa","Africa","N","Kenya"),
            "Madagascar":                   _ch("Eastern Africa","Africa","A","Madagascar"),
            "Malawi":                       _ch("Eastern Africa","Africa","L","Malawi"),
            "Mauritius":                    _ch("Eastern Africa","Africa","P","Mauritius"),
            "Mozambique":                   _ch("Eastern Africa","Africa","M","Mozambique"),
            "Rwanda":                       _ch("Eastern Africa","Africa","K","Rwanda"),
            "Seychelles":                   _ch("Eastern Africa","Africa","V","Seychelles"),
            "Somalia":                      _ch("Eastern Africa","Africa","M","Somalia"),
            "South Sudan":                  _ch("Eastern Africa","Africa","J","South Sudan"),
            "Tanzania":                     _ch("Eastern Africa","Africa","D","Tanzania"),
            "Uganda":                       _ch("Eastern Africa","Africa","K","Uganda"),
            "Zambia":                       _ch("Eastern Africa","Africa","L","Zambia"),
            "Zimbabwe":                     _ch("Eastern Africa","Africa","H","Zimbabwe"),
            # Southern Africa
            "Botswana":                     _ch("Southern Africa","Africa","G","Botswana"),
            "Eswatini":                     _ch("Southern Africa","Africa","M","Eswatini"),
            "Lesotho":                      _ch("Southern Africa","Africa","M","Lesotho"),
            "Namibia":                      _ch("Southern Africa","Africa","W","Namibia"),
            "South Africa":                 _ch("Southern Africa","Africa","P","South Africa"),
        }
    }
    ...
    "countries_europe" = {
        ...
        "answers_hints": {
            # Northern Europe
            "Denmark":                      _ch("Northern Europe","Europe","C","Denmark"),
            "Estonia":                      _ch("Northern Europe","Europe","T","Estonia"),
            "Finland":                      _ch("Northern Europe","Europe","H","Finland"),
            "Iceland":                      _ch("Northern Europe","Europe","R","Iceland"),
            "Ireland":                      _ch("Northern Europe","Europe","D","Ireland"),
            "Latvia":                       _ch("Northern Europe","Europe","R","Latvia"),
            "Lithuania":                    _ch("Northern Europe","Europe","V","Lithuania"),
            "Norway":                       _ch("Northern Europe","Europe","O","Norway"),
            "Sweden":                       _ch("Northern Europe","Europe","S","Sweden"),
            "United Kingdom":               _ch("Northern Europe","Europe","L","United Kingdom"),
            # Western Europe
            "Austria":                      _ch("Western Europe","Europe","V","Austria"),
            "Belgium":                      _ch("Western Europe","Europe","B","Belgium"),
            "France":                       _ch("Western Europe","Europe","P","France"),
            "Germany":                      _ch("Western Europe","Europe","B","Germany"),
            "Liechtenstein":                _ch("Western Europe","Europe","V","Liechtenstein"),
            "Luxembourg":                   _ch("Western Europe","Europe","L","Luxembourg"),
            "Monaco":                       _ch("Western Europe","Europe","M","Monaco"),
            "Netherlands":                  _ch("Western Europe","Europe","A","Netherlands"),
            "Switzerland":                  _ch("Western Europe","Europe","B","Switzerland"),
            # Southern Europe
            "Albania":                      _ch("Southern Europe","Europe","T","Albania"),
            "Andorra":                      _ch("Southern Europe","Europe","A","Andorra"),
            "Bosnia and Herzegovina":       _ch("Southern Europe","Europe","S","Bosnia and Herzegovina"),
            "Croatia":                      _ch("Southern Europe","Europe","Z","Croatia"),
            "Cyprus":                       _ch("Southern Europe","Europe","N","Cyprus"),
            "Greece":                       _ch("Southern Europe","Europe","A","Greece"),
            "Italy":                        _ch("Southern Europe","Europe","R","Italy"),
            "Kosovo":                       _ch("Southern Europe","Europe","P","Kosovo"),
            "Malta":                        _ch("Southern Europe","Europe","V","Malta"),
            "Montenegro":                   _ch("Southern Europe","Europe","P","Montenegro"),
            "North Macedonia":              _ch("Southern Europe","Europe","S","North Macedonia"),
            "Portugal":                     _ch("Southern Europe","Europe","L","Portugal"),
            "San Marino":                   _ch("Southern Europe","Europe","S","San Marino"),
            "Serbia":                       _ch("Southern Europe","Europe","B","Serbia"),
            "Slovenia":                     _ch("Southern Europe","Europe","L","Slovenia"),
            "Spain":                        _ch("Southern Europe","Europe","M","Spain"),
            "Vatican City":                 _ch("Southern Europe","Europe","V","Vatican City"),
            # Eastern Europe
            "Belarus":                      _ch("Eastern Europe","Europe","M","Belarus"),
            "Bulgaria":                     _ch("Eastern Europe","Europe","S","Bulgaria"),
            "Czech Republic":               _ch("Eastern Europe","Europe","P","Czech Republic"),
            "Hungary":                      _ch("Eastern Europe","Europe","B","Hungary"),
            "Moldova":                      _ch("Eastern Europe","Europe","C","Moldova"),
            "Poland":                       _ch("Eastern Europe","Europe","W","Poland"),
            "Romania":                      _ch("Eastern Europe","Europe","B","Romania"),
            "Russia":                       _ch("Eastern Europe","Europe","M","Russia"),
            "Slovakia":                     _ch("Eastern Europe","Europe","B","Slovakia"),
            "Ukraine":                      _ch("Eastern Europe","Europe","K","Ukraine"),
        }
    }
    ...
    "countries_asia" = {
        ...
        "answers_hints": {
            # Central Asia
            "Kazakhstan":                   _ch("Central Asia","Asia","A","Kazakhstan"),
            "Kyrgyzstan":                   _ch("Central Asia","Asia","B","Kyrgyzstan"),
            "Tajikistan":                   _ch("Central Asia","Asia","D","Tajikistan"),
            "Turkmenistan":                 _ch("Central Asia","Asia","A","Turkmenistan"),
            "Uzbekistan":                   _ch("Central Asia","Asia","T","Uzbekistan"),
            # East Asia
            "China":                        _ch("East Asia","Asia","B","China"),
            "Japan":                        _ch("East Asia","Asia","T","Japan"),
            "Mongolia":                     _ch("East Asia","Asia","U","Mongolia"),
            "North Korea":                  _ch("East Asia","Asia","P","North Korea"),
            "South Korea":                  _ch("East Asia","Asia","S","South Korea"),
            "Taiwan":                       _ch("East Asia","Asia","T","Taiwan"),
            # South Asia
            "Afghanistan":                  _ch("South Asia","Asia","K","Afghanistan"),
            "Bangladesh":                   _ch("South Asia","Asia","D","Bangladesh"),
            "Bhutan":                       _ch("South Asia","Asia","T","Bhutan"),
            "India":                        _ch("South Asia","Asia","N","India"),
            "Maldives":                     _ch("South Asia","Asia","M","Maldives"),
            "Nepal":                        _ch("South Asia","Asia","K","Nepal"),
            "Pakistan":                     _ch("South Asia","Asia","I","Pakistan"),
            "Sri Lanka":                    _ch("South Asia","Asia","S","Sri Lanka"),
            # Southeast Asia
            "Brunei":                       _ch("Southeast Asia","Asia","B","Brunei"),
            "Cambodia":                     _ch("Southeast Asia","Asia","P","Cambodia"),
            "Indonesia":                    _ch("Southeast Asia","Asia","J","Indonesia"),
            "Laos":                         _ch("Southeast Asia","Asia","V","Laos"),
            "Malaysia":                     _ch("Southeast Asia","Asia","K","Malaysia"),
            "Myanmar":                      _ch("Southeast Asia","Asia","N","Myanmar"),
            "Philippines":                  _ch("Southeast Asia","Asia","M","Philippines"),
            "Singapore":                    _ch("Southeast Asia","Asia","S","Singapore"),
            "Thailand":                     _ch("Southeast Asia","Asia","B","Thailand"),
            "Timor-Leste":                  _ch("Southeast Asia","Asia","D","Timor-Leste"),
            "Vietnam":                      _ch("Southeast Asia","Asia","H","Vietnam"),
            # Western Asia
            "Armenia":                      _ch("Western Asia","Asia","Y","Armenia"),
            "Azerbaijan":                   _ch("Western Asia","Asia","B","Azerbaijan"),
            "Bahrain":                      _ch("Western Asia","Asia","M","Bahrain"),
            "Georgia":                      _ch("Western Asia","Asia","T","Georgia"),
            "Iran":                         _ch("Western Asia","Asia","T","Iran"),
            "Iraq":                         _ch("Western Asia","Asia","B","Iraq"),
            "Israel":                       _ch("Western Asia","Asia","J","Israel"),
            "Jordan":                       _ch("Western Asia","Asia","A","Jordan"),
            "Kuwait":                       _ch("Western Asia","Asia","K","Kuwait"),
            "Lebanon":                      _ch("Western Asia","Asia","B","Lebanon"),
            "Oman":                         _ch("Western Asia","Asia","M","Oman"),
            "Palestine":                    _ch("Western Asia","Asia","R","Palestine"),
            "Qatar":                        _ch("Western Asia","Asia","D","Qatar"),
            "Saudi Arabia":                 _ch("Western Asia","Asia","R","Saudi Arabia"),
            "Syria":                        _ch("Western Asia","Asia","D","Syria"),
            "Turkey":                       _ch("Western Asia","Asia","A","Turkey"),
            "United Arab Emirates":         _ch("Western Asia","Asia","A","United Arab Emirates"),
            "Yemen":                        _ch("Western Asia","Asia","S","Yemen"),
        }
    }
    ...
    "countries_americas" = {
        ...
        "answers_hints": {
            # North America
            "Canada":                       _ch("North America","the Americas","O","Canada"),
            "Mexico":                       _ch("North America","the Americas","M","Mexico"),
            "United States":                _ch("North America","the Americas","W","United States"),
            # Central America
            "Belize":                       _ch("Central America","the Americas","B","Belize"),
            "Costa Rica":                   _ch("Central America","the Americas","S","Costa Rica"),
            "El Salvador":                  _ch("Central America","the Americas","S","El Salvador"),
            "Guatemala":                    _ch("Central America","the Americas","G","Guatemala"),
            "Honduras":                     _ch("Central America","the Americas","T","Honduras"),
            "Nicaragua":                    _ch("Central America","the Americas","M","Nicaragua"),
            "Panama":                       _ch("Central America","the Americas","P","Panama"),
            # Caribbean
            "Antigua and Barbuda":          _ch("the Caribbean","the Americas","S","Antigua and Barbuda"),
            "Bahamas":                      _ch("the Caribbean","the Americas","N","Bahamas"),
            "Barbados":                     _ch("the Caribbean","the Americas","B","Barbados"),
            "Cuba":                         _ch("the Caribbean","the Americas","H","Cuba"),
            "Dominica":                     _ch("the Caribbean","the Americas","R","Dominica"),
            "Dominican Republic":           _ch("the Caribbean","the Americas","S","Dominican Republic"),
            "Grenada":                      _ch("the Caribbean","the Americas","S","Grenada"),
            "Haiti":                        _ch("the Caribbean","the Americas","P","Haiti"),
            "Jamaica":                      _ch("the Caribbean","the Americas","K","Jamaica"),
            "Saint Kitts and Nevis":        _ch("the Caribbean","the Americas","B","Saint Kitts and Nevis"),
            "Saint Lucia":                  _ch("the Caribbean","the Americas","C","Saint Lucia"),
            "Saint Vincent and the Grenadines": _ch("the Caribbean","the Americas","K","Saint Vincent and the Grenadines"),
            "Trinidad and Tobago":          _ch("the Caribbean","the Americas","P","Trinidad and Tobago"),
            # South America
            "Argentina":                    _ch("South America","the Americas","B","Argentina"),
            "Bolivia":                      _ch("South America","the Americas","S","Bolivia"),
            "Brazil":                       _ch("South America","the Americas","B","Brazil"),
            "Chile":                        _ch("South America","the Americas","S","Chile"),
            "Colombia":                     _ch("South America","the Americas","B","Colombia"),
            "Ecuador":                      _ch("South America","the Americas","Q","Ecuador"),
            "Guyana":                       _ch("South America","the Americas","G","Guyana"),
            "Paraguay":                     _ch("South America","the Americas","A","Paraguay"),
            "Peru":                         _ch("South America","the Americas","L","Peru"),
            "Suriname":                     _ch("South America","the Americas","P","Suriname"),
            "Uruguay":                      _ch("South America","the Americas","M","Uruguay"),
            "Venezuela":                    _ch("South America","the Americas","C","Venezuela"),
        }
    }
    ...
    "countries_oceania" = {
        ...
        "answers_hints": {
            ...
            "Australia":                    _ch("Australia and New Zealand","Oceania","C","Australia"),
            "New Zealand":                  _ch("Australia and New Zealand","Oceania","W","New Zealand"),
            # Melanesia
