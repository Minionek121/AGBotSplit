...
countries_africa = {
    ...
    "answers_hints": {
        ...
        "Ivory Coast":                  _ch("Western","Africa","Y","Ivory Coast"),
        "Gambia":                       _ch("Western","Africa","B","Gambia"),
        "Ghana":                        _ch("Western","Africa","A","Ghana"),
        "Guinea":                       _ch("Western","Africa","C","Guinea"),
        "Guinea-Bissau":                _ch("Western","Africa","B","Guinea-Bissau"),
        "Liberia":                      _ch("Western","Africa","M","Liberia"),
        "Mali":                         _ch("Western","Africa","B","Mali"),
        "Mauritania":                   _ch("Western","Africa","N","Mauritania"),
        "Niger":                        _ch("Western","Africa","N","Niger"),
        "Nigeria":                      _ch("Western","Africa","A","Nigeria"),
        ...
        "Chad":                         _ch("Central","Africa","N","Chad"),
        "Democratic Republic of the Congo": _ch("Central","Africa","K","Democratic Republic of the Congo"),
        "Equatorial Guinea":            _ch("Central","Africa","M","Equatorial Guinea"),
        ...
        "Eritrea":                      _ch("Eastern","Africa","A","Eritrea"),
        "Ethiopia":                     _ch("Eastern","Africa","A","Ethiopia"),
        "Kenya":                        _ch("Eastern","Africa","N","Kenya"),
        "Madagascar":                   _ch("Eastern","Africa","A","Madagascar"),
        "Malawi":                       _ch("Eastern","Africa","L","Malawi"),
        "Mauritius":                    _ch("Eastern","Africa","P","Mauritius"),
        "Mozambique":                   _ch("Eastern","Africa","M","Mozambique"),
        "Rwanda":                       _ch("Eastern","Africa","K","Rwanda"),
        "Seychelles":                   _ch("Eastern","Africa","V","Seychelles"),
        "Somalia":                      _ch("Eastern","Africa","M","Somalia"),
        "South Sudan":                  _ch("Eastern","Africa","J","South Sudan"),
        "Tanzania":                     _ch("Eastern","Africa","D","Tanzania"),
        ...
        "Namibia":                      _ch("Southern","Africa","W","Namibia"),
        "South Africa":                 _ch("Southern","Africa","P","South Africa"),
    }
}
...
countries_europe = {
    ...
    "answers_hints": {
        ...
        "Iceland":                      _ch("Northern","Europe","R","Iceland"),
        "Ireland":                      _ch("Northern","Europe","D","Ireland"),
        "Latvia":                       _ch("Northern","Europe","R","Latvia"),
        "Lithuania":                    _ch("Northern","Europe","V","Lithuania"),
        ...
        "Germany":                      _ch("Western","Europe","B","Germany"),
        "Liechtenstein":                _ch("Western","Europe","V","Liechtenstein"),
        "Luxembourg":                   _ch("Western","Europe","L","Luxembourg"),
        ...
        "Croatia":                      _ch("Southern","Europe","Z","Croatia"),
        "Cyprus":                       _ch("Southern","Europe","N","Cyprus"),
        "Greece":                       _ch("Southern","Europe","A","Greece"),
        "Italy":                        _ch("Southern","Europe","R","Italy"),
        "Kosovo":                       _ch("Southern","Europe","P","Kosovo"),
        "Malta":                        _ch("Southern","Europe","V","Malta"),
        "Montenegro":                   _ch("Southern","Europe","P","Montenegro"),
        "North Macedonia":              _ch("Southern","Europe","S","North Macedonia"),
        "Portugal":                     _ch("Southern","Europe","L","Portugal"),
        "San Marino":                   _ch("Southern","Europe","S","San Marino"),
        "Serbia":                       _ch("Southern","Europe","B","Serbia"),
        ...
        "Hungary":                      _ch("Eastern","Europe","B","Hungary"),
        "Moldova":                      _ch("Eastern","Europe","C","Moldova"),
        "Poland":                       _ch("Eastern","Europe","W","Poland"),
        "Romania":                      _ch("Eastern","Europe","B","Romania"),
        "Russia":                       _ch("Eastern","Europe","M","Russia"),
        "Slovakia":                     _ch("Eastern","Europe","B","Slovakia"),
        "Ukraine":                      _ch("Eastern","Europe","K","Ukraine"),
    }
}
...
countries_asia = {
    ...
    "answers_hints": {
        ...
        "India":                        _ch("South","Asia","N","India"),
        "Maldives":                     _ch("South","Asia","M","Maldives"),
        ...
        "Laos":                         _ch("Southeast","Asia","V","Laos"),
        "Malaysia":                     _ch("Southeast","Asia","K","Malaysia"),
        "Myanmar":                      _ch("Southeast","Asia","N","Myanmar"),
        "Philippines":                  _ch("Southeast","Asia","M","Philippines"),
        "Singapore":                    _ch("Southeast","Asia","S","Singapore"),
        ...
        "Georgia":                      _ch("Western","Asia","T","Georgia"),
        "Iran":                         _ch("Western","Asia","T","Iran"),
        "Iraq":                         _ch("Western","Asia","B","Iraq"),
        "Israel":                       _ch("Western","Asia","J","Israel"),
        "Jordan":                       _ch("Western","Asia","A","Jordan"),
        "Kuwait":                       _ch("Western","Asia","K","Kuwait"),
        "Lebanon":                      _ch("Western","Asia","B","Lebanon"),
        "Oman":                         _ch("Western","Asia","M","Oman"),
        "Palestine":                    _ch("Western","Asia","R","Palestine"),
        "Qatar":                        _ch("Western","Asia","D","Qatar"),
        "Saudi Arabia":                 _ch("Western","Asia","R","Saudi Arabia"),
        "Syria":                        _ch("Western","Asia","D","Syria"),
        "Turkey":                       _ch("Western","Asia","A","Turkey"),
        "United Arab Emirates":         _ch("Western","Asia","A","United Arab Emirates"),
        "Yemen":                        _ch("Western","Asia","S","Yemen"),
    }
}
...
countries_americas = {
    ...
    "answers_hints": {
        ...
        "Guatemala":                    _ch("Central America","","G","Guatemala"),
        ...
        "Cuba":                         _ch("the Caribbean","","H","Cuba"),
        "Dominica":                     _ch("the Caribbean","","R","Dominica"),
        "Dominican Republic":           _ch("the Caribbean","","S","Dominican Republic"),
        "Grenada":                      _ch("the Caribbean","","S","Grenada"),
        "Haiti":                        _ch("the Caribbean","","P","Haiti"),
        "Jamaica":                      _ch("the Caribbean","","K","Jamaica"),
        "Saint Kitts and Nevis":        _ch("the Caribbean","","B","Saint Kitts and Nevis"),
        ...
        "Chile":                        _ch("South America","","S","Chile"),
        "Colombia":                     _ch("South America","","B","Colombia"),
        "Ecuador":                      _ch("South America","","Q","Ecuador"),
        "Guyana":                       _ch("South America","","G","Guyana"),
        "Paraguay":                     _ch("South America","","A","Paraguay"),
        "Peru":                         _ch("South America","","L","Peru"),
        "Suriname":                     _ch("South America","","P","Suriname"),
        "Uruguay":                      _ch("South America","","M","Uruguay"),
        "Venezuela":                    _ch("South America","","C","Venezuela"),
    }
}
